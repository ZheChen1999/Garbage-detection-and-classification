...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/train/cz.data', help='coco.data file path')
    parser.add_argument('--weights', type=str, default='data/train/yolov3_4000.weights', help='path to weights file')
